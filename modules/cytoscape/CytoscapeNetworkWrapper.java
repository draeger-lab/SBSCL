...
//		CytoscapeAnnotationManager prop = (CytoscapeAnnotationManager) getAnnotationManager();
		...
		for (int i=0; i<reactions.length; i++) {
			...
			int[] edges = net.getAdjacentEdgeIndicesArray(net.getIndex(reactions[i].getNode()), true, true, true);
...
//				else if (prop.isReactionToReactantEdge(e))
					...
					throw new IllegalArgumentException("Edge "+e.getIdentifier()+" cannot be identified!");
			}
