        ...
        new Thread(new Runnable() {
          ...
          public void run() {
            try {
              ...
              AmountIntervalObserver[] trendObserver = createTrendObservers(sim,
                  extended.getTrendSpecies(), overview.getTime());
//							sim.addObserver(new InstantOutputObserver(sim,new PrintWriter("sim.log")));
  ...
  private AmountIntervalObserver[] createTrendObservers(Simulator sim, String[] trendSpecies,
      double time) {
