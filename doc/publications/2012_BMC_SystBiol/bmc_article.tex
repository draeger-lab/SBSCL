...
roland.keller@unituebingen.de}, 
Alexander D\"orr$^{1}$\correspondingauthor\email{Alexander D\"orr -
alexander.doerr@unituebingen.de},  
...
such as the Systems Biology Markup Language (SBML, \cite{Hucka2004}) or
CellML \cite{Lloyd2004} enable encoding of biological network models, and
...
% incomplete and is not necessary} \sout{, for instance, the Virtual Cell \cite{Loew2001}, iBioSim \cite{Myers2009},
%PottersWheel \cite{Maiwald2008}, COPASI \cite{Hoops2006}, SBToolbox2
%\cite{SBT_Schmidt2006}}
...
%\sout{The SBML ODE Solver Library \cite{Machne2006}, which is written in C,
