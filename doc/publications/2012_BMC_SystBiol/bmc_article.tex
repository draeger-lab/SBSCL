...
reaching from the graphical represenatation \cite{Gauges2006} to the description
of qualitative networks, such as Petri nets \cite{Chaouiya2012} etc. 
It is therefore necessary to separately derive and implmeent algorithms for the interpretation of individual extension packages.}
