...
metabolites, genes, \COR{and} fluxes\COR{,} the description of \TODO{dynamical systems by
differential equation models} \COR{is becoming more} popular in systems biology.
%driven by the aim to make biological phenomena predictable. 
Models are often encoded in formats such as \acs{SBML}, whose mathematical
structure is very complex and difficult to evaluate due to many special cases \COR{of \acs{SBML} structures}.
...
\TODO{differential equation systems} \COR{derived from} \acs{SBML} models.
...
of the \acs{LGPL} version~3 from \url{http://simulation-core.sourceforge.net}.
