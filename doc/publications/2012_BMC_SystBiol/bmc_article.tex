...
mentioned above.}
\TODO{It should be mentioned that iBioSim does not primarily focus on the use of
...
Windows\textsuperscript{\textregistered}~7 (Version 6.1.7600) as operating system \COR{and Java Virtual Machine version 1.6.0\_25}. 
\par \mbox{}
\par
    \mbox{
