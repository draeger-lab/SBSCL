...
interoperability\COR{,} and the possibility to combine models have been recognized as
...
Draeger2011b} and a 
\TODO{large variety of programs supports these model description languages}.
...
encoded in the \acs{SBML} format \COR{in terms of ordinary differential equation systems}.
Furthermore, we show how to adapt existing \COR{numerical} integration routines in order to simulate \sout{\acs{SBML}}\COR{these} models.
...
\sout{As a reference implementation, w}\COR{W}e introduce an exhaustive \COR{reference} implementation in \sout{the}
