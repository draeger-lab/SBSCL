...
The table shows for all SBML levels and versions the number of tested models and the total running times of the tests. An Intel\textsuperscript{\textregistered} Core\textsuperscript{\texttrademark} i5 CPU with 3.33 GHz  and 4 GB RAM was used with Windows 7 (Version 6.1.7600) as operating system.\par \mbox{}
\par
    \mbox{
\begin{tabular} {|c|c|c|c|c|}
\hline
Level & Version & Models & Correct simulations & Total running time\\\hline
1&2&252&252&1.1 s\\ \hline
2&1&885&885&3.6 s\\ \hline
2&2&1039&1039&3.3 s\\ \hline
2&3&1039&1039&3.2 s\\ \hline
2&4&1041&1041&3.2 s\\ \hline
3&1&1075&1075&34.3 s\\ \hline
\end{tabular}
}
