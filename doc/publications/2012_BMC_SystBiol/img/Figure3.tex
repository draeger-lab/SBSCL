...
\begin{tikzpicture}[node distance = 2cm, auto]
    ...
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (triggerEvents) -- node{No} (updateInactive);
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (triggerEvents) -- node{Yes} (decision2);
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (updateInactive) -- (increase2);
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (decision2) -- node{No} (updateRunningEvents);
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (decision2) -- node{Yes} (aux4) -| (increase2);
    ...
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (decision3) -- node{Yes} (noRunningEvents);
    ...
    \draw [color = black, line width = 1.0pt, ->, -triangle 60] (noRunningEvents) -- node{No} (chooseEvent);
