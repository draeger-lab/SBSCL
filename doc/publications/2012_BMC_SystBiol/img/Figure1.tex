...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.5cm,
  ...
  \node[main node] (kass1) [below left of=times1] {$k_{ass1}$};
...
\node[main node] (kdiss1) [below left of=times2] {$k_{diss1}$};
...
\node[main node] (times3) [node distance = 3cm] [below left of=minus2] {$\cdot$};
  \node[main node] (kass2) [below right of=times3] {$k_{ass2}$};

\node[main node] (times4)[node distance = 3cm] [below right of=minus2] {$\cdot$};
\node[main node] (kdiss2) [below right of=times4] {$k_{diss2}$};
