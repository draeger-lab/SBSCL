...
Algebraic rules are transferred to assignment rules before the simulation\marginpar{This is only valid for polynomes. And for those, assignmentRules should have been used anyway. How do-you proceed for cos(x)=0?}: One
of the variables contained in an algebraic rule is chosen as the variable of the
created assignment rule and the equation is solved for this variable.\marginpar{How do-you choose the variable?} The
...
instance CellML\marginpar{Is this being done?}. To this end, it is only necessary to implement a suitable
interpreter class.
