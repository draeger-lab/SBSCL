...
public class SBMLTestSuiteTest {
  ...
  public void testModel() throws IOException {
    ...
    String[] failedTests = new String[]{
        ...
        "01175", "01176", "01178", "01180", "01181", "01182", "01183", "01344", "01345", "01346",
        "01347", "01348", "01349", "01350", "01351", "01352", "01355", "01356", "01358", "01359",
    ...
    double absolute =
        (!props.getProperty(ABSOLUTE).isEmpty()) ? Double.parseDouble(props.getProperty(ABSOLUTE))
            : 0d;
    double relative =
        (!props.getProperty(RELATIVE).isEmpty()) ? Double.parseDouble(props.getProperty(RELATIVE))
            : 0d;
      ...
      if ((sbmlFile != null) && (sbmlFile.exists())) {
        ...
        if (model.getExtension(CompConstants.shortLabel) != null) {
          ...
          if ((solver != null) && (interpreter != null)) {
            ...
            MultiTable solution = solveSBMLModel(solver, interpreter, duration, steps, timepoints,
                absolute, relative);
  ...
  /**
   * Compares the simulation results with the reference results given in the SBML Test Suite.
   *
   ...
   */
  private void compareSBMLResults(MultiTable solution, MultiTable inputData, double absolute,
      double relative) {
  ...
  /**
   * Simulates the SBML models with FBC extension and compares the results with reference results
