...
/**
 * Observes the amount of given molecule species at each <code>step</code>. It particularly
 * makes sense for the approximative leaping algorithms whose <code>step</code>s are 
 ...
 * you will just get the results of the recent run.
 * 
