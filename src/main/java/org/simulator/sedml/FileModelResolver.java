...
public class FileModelResolver implements IModelResolver {
  ...
  public String getModelXMLFor(URI modelURI) {
    String path = null;
    if (modelURI.getAuthority() == null && modelURI.getScheme() == null && modelURI.getHost() == null) {
    ...
    } else if (modelURI.getAuthority() == null && "file".equals(modelURI.getScheme()) && modelURI.getHost() == null) {
      path = modelURI.getPath();
    } else {
      return null;
    }
