...
/**
 * Uses the Irreversible-isomerization model to show effects of different choices for epsilon. The
 * number of leaps is slightly greater than proposed in the paper because in the paper tau wasn't
 * bound by sigma yet (yielding sometimes to lower tau and hence more leaps)
 * <p>
...
public class IrreversibleIsomerization {
  ...
  public static void main(String[] args) throws IOException, JDOMException {
    ...
    AmountIntervalObserver amount = (AmountIntervalObserver) ssa
        .addObserver(new AmountIntervalObserver(ssa, 0.01, "S1"));
    ssa.start(endTime);
