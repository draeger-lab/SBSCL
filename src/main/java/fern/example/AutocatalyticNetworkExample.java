...
/**
 * Here, the evolution of a reaction network as proposed by [1] is performed. Then, the
 * autocatalytic subset [1] is determined and extracted. This subnet is then simulated to examine
 * the dynamic behaviour of autocatalytic reaction networks. For more information about the
 * evolution and the detection algorithm, please refer {@link AutocatalyticNetwork} and {@link
 * AutocatalyticNetworkDetection}.
 * <p>
 * References: [1] Kauffmann S.A, The Origins of Order: Self-Organization and Selection in
...
public class AutocatalyticNetworkExample {
  ...
  public static void main(String[] args) throws IOException {
     ...
     */
    Network autoNet = new ExtractSubNetwork(netR, detection.getAutocatalyticReactions(),
        detection.getAutocatalyticSpecies());
    System.out.println();
    ...
    IntervalObserver obs2 = new AmountIntervalObserver(sim, 1,
  ...
  private static class AutocatalyticReactionsAllObserver extends ReactionIntervalObserver {
    ...
    public AutocatalyticReactionsAllObserver(Simulator sim, double interval) {
      super(sim, interval, NetworkTools.getSpeciesNames(sim.getNet(),
          NumberTools.getNumbersTo(sim.getNet().getNumSpecies() - 1)));
      setLabelFormat("");
    }
