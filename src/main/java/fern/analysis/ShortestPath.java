...
public class ShortestPath extends AnalysisBase {
	...
	public class Path {
		...
		/**
		 * Creates a path from an array. The array has to end with a species and has
		 * to be composed of alternating indices of species and reactions.
		...
		/**
		 * Returns the raw path: Is ends with a species index and is composed of alternating
		 * indices of species and reactions.
