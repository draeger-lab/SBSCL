...
/**
 * A <code>CatalystIterator</code> is used to enumerate the catalysts of a reaction in an {@link
 * AutocatalyticNetwork}. For instance the {@link AutocatalyticNetworkDetection} uses it to be able
 * to walk from reactions to their catalysts in its breadth first searches.
 *
