 ...
 * reactions have annotation with fields ending with <code>REVERSIBLE_SUFFIX</code>. If such
 ...
 * reactions have annotations <code>Catalyst</code> and <code> CatalystReversible</code>, if you
 * create a <code>ReversibleNetwork</code> out of this, each reaction will have only the annotation
 * <code>Catalyst</code>).
 * <p>
 ...
 * two reactions, A+A->B, B->C, the <code>PropensityCalculatory</code> has to calculate the
...
public class ReversibleNetwork extends ModifierNetwork {
   ...
   * @param reversiblePropensityCalculator the <code>PropensityCalculator</code> for the reverse
   *                                       reactions
   */
   ...
   * <code>PropensityCalculator</code> and the one for the reverse reactions is a {@link
   * AbstractKineticConstantPropensityCalculator}, an <code>AbstractKineticConstantPropensityCalculator</code>
   * is returned.
   *
