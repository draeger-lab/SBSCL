...
/**
 * A <code>PropensityCalculator</code> is the way, a {@link Network} tells a {@link Simulator} how
 * to calculate propensities for the reactions. Each <code>Simulator</code> calls the <code>
...
public interface PropensityCalculator {
   ...
   * rate constants and are hence to be transformed to specific reaction rate constants.
   *
