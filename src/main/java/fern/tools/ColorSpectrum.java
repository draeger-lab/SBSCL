...
public class ColorSpectrum {
  ...
  /**
   * Gets a color representing the given number in an given color scale. You can give as much colors
   * as you want. The resulting color will be interpolated.
   *
  ...
  public static Color getSpectrum(float val, Color... colors) {
    ...
    return new Color(
        ...
        colors[leftIndex].getGreen() / 255f * (1 - val)
            + colors[rightIndex].getGreen() / 255f * val,
