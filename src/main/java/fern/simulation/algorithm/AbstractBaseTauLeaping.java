 ...
 * <p>
 * For references see Daniel T. Gillespie, Approximate accelerated stochastic simulation of
 * chemically reacting systems, Journal of chemical physics vol 115, nr 4 (2001); Cao et al.,
 * Efficient step size selection for the tau-leaping simulation method, Journal of chemical physics
 * 124, 044109 (2006)
 *
...
public abstract class AbstractBaseTauLeaping extends GillespieEnhanced {
  ...
  /**
   * Draws the only critical reaction which is supposed to be fired, if the second tau candidate has
   * won.
   *
   * @param criticals Bitvector identifying the critical reactions
   * @return
   ...
   * the poisson distribution. The default value is Infinity (no approximation).
   *
  ...
  /**
   * The numSimpleCalls determines, how often the SSA is called, when tau leaping is abandoned. The
  ...
  /**
   * The nCritical determines, when a reaction is called critical. It is critical, when the maximum
   * number, a reaction can fire before exhausting one of its reactants is less than nCritical. The
   * default value is 10.
   *
   ...
   * functions by epsilon * a_sum. It has to be 0 &lt; epsilon &lt;&lt; 1. The default value is
   * 0.03.
   *
   * @return the epsilon
   */
