...
/**
 * Observes amounts of molecule species repeatedly after certain intervals. The amount of the given
 * molecules is summed up.
 * <p>
...
public class MultiAmountIntervalObserver extends IntervalObserver {
   ...
   */
  public MultiAmountIntervalObserver(Simulator sim, String presentationName, double interval,
      int... species) {
