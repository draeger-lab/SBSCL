 ...
 * accomplish that, this class also implements a {@link SimulationController} and 
 * registers a <code>theta</code> at the simulator. The data produced after are histograms
...
public class AmountAtMomentObserver extends Observer implements SimulationController, GnuPlotObserver {
	...
	/**
	 * Causes the simulator to stop when <code>theta</code> has been passed and the amounts
	 * have been recorded.
	 */
