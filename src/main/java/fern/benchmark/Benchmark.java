...
/**
 * Base class for all benchmark classes. Gives methods for measuring elapsed time as well as methods
 * for creating test sets and benchmark data handling.
 *
...
public abstract class Benchmark {
  ...
  /**
   * Creates a test set containing <code>size</code> random numbers of the distribution
   * <code>dist</code>.
   *
