...
/**
 * Benchmark the {@link FireType}s for a given net. Use this benchmark, if you want to know, how
 * many SSA steps are performed at tau leaping for a given network. The <code>benchmark</code>
 * method can be invoked repeatedly to calculate the average over many simulations.
 *
