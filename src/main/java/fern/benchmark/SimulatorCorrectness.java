 ...
 * Additionally the histograms are plotted. The <code>benchmark</code> method can be invoked
...
public class SimulatorCorrectness extends SimulatorPerformance {
    ...
    /**
     * Gets called after some iterations of the method <code>benchmark</code> in the base class.
