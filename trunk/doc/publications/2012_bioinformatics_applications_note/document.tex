...
\begin{abstract}
\section{Motivation:}
Dynamic simulation of biological phenomena belongs to the key aspects of
...
To demonstrate its capabilities, it has been benchmarked against the
...
\section{Contact:}
\TODO{\href{mailto:andreas.draeger@uni-tuebingen.de}{andreas.draeger@uni-tuebingen.de}}
%
...
\newblock {\em Nucleic Acids Research\/}, {\bf 34}, D689--D691.
