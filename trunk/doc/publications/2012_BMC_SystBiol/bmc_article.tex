...
\TODO{With the increasing availability of high dimensional time course data for metabolites or genes, the description of dynamical systems by differential equations becomes increasingly popular in systems biology. 
These differential equation systems are often encoded in Systems Biology Markup Language (SBML). In order to simulate such SBML models, an efficient interpreter for SBML as well as numerical integrators are necessary.  
This article describes an efficient algorithm to interpret and
solve the differential equation systems of SBML models and its implementation as part of the Systems Biology Simulation Core
