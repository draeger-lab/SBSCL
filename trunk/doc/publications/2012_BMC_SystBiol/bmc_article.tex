...
Dynamic simulation of biological phenomena is a key aspect of
...
SBML Test Suite (version 2.0.2) using Rosenbrock solver. The results are shown in Table~2.
%(see
...
\TODO{Replace this table with a comparison table to other tools.}
  ...
  \subsection*{Table 1 - Other simulators for SBML models}
...
\hline
Name 	& FR & AR& EV &Model 966& Model 988& Model 1083 & Model 1000 &Programming language&API access & Version & Platform & Comments & SED-ML support\\\hline
BioUML & Yes& Yes& Yes& Correct & Correct & Correct & Correct &Java &JavaScript API for parameters fitting &0.9.3 & Platform independent (Java) & Integrators: JVODE, DormandPrince, Radau5, Euler, Imex & Only in alpha version\\\hline
COPASI &No & No & Not every feature supported &Not correct & Not correct & Not correct& Not correct&	C++ with multiple language bindings & Yes &4.8.0& Windows, Linux, Mac OS X, Solaris & & No\\\hline
iBioSim &Yes&Yes&Yes&Correct & Correct & Correct & Correct & Java & No&2.0.0 & Fedora 15, Windows, Mac OS > 10.6 && No\\\hline
JSim & No & Yes & No & Not correct&Not correct& Correct&	Not correct & Java & Yes &2.07.0 & Windows, Linux, Mac OS X && No\\\hline
JWS Online &No&No&No&Not correct&Not correct&Not correct& Not correct& Java & No&& Online program & Supports only SBML Level 1 and Level 2. & No \\\hline
LibSBMLSim &Yes& Yes & Yes& Correct&Correct & Correct & Correct & C & Yes &1.0.0 &Windows, Linux, Free BSD, Mac OS X& Only L3, L2V4 supported & No\\\hline
VCell &Yes& No &Yes&Not correct&Not correct & Not correct & Not correct &Java frontend C/C++ server backend & No & 5.0.0 & Platform independent (Java) & Requires internet connection & No\\\hline
 \end{tabular}
\end{landscape}
...
The table shows for all SBML levels and versions the number of tested models and the total running times of the tests. \par \mbox{}
\par
    \mbox{
