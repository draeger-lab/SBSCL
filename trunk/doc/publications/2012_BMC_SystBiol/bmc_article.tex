...
influence the reaction velocities, but which are not part of the global apramter
...
An assignment rule also influences the asolute value of some model.
...
computing the sulution of the simple Equation~\ref{eq:SpeciesChange} alone.
...
The next sections will give a detailled explanation of the necessary steps to
